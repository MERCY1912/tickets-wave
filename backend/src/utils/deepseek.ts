...
export class DeepSeekClient {
  ...
  async listModels(): Promise<string[]> {
    try {
      ...
      throw new DeepSeekError(`Failed to list models: ${error instanceof Error ? error.message : 'Unknown error'}`);
    }
  }
  ...
  async chat(options: DeepSeekOptions): Promise<string> {
    try {
      ...
      throw new DeepSeekError(`Failed to chat: ${error instanceof Error ? error.message : 'Unknown error'}`);
    }
  }
}
